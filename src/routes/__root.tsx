...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Strikr — Football, Reimagined" },
      { property: "og:description", content: "The all-in-one football ecosystem: pitches, teams, tournaments, academy, marketplace and more." },
